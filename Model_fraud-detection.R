# FRAUD DETECTION
#-------------------------------------------------------------------------------------------------------------------------------------
# The dataset contains 20000 records and 31 columns. 
#-------------------------------------------------------------------------------------------------------------------------------------
...
#Loading the dataset
card<-read.csv("D:/Shalaka(All Data)/Intellipaat/Data Science with R/Data Science with R Part-I/Project-4/creditcard.csv")
